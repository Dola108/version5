...
<body style="background-image: url('5.jpg'); background-size: 220%; background-repeat: no-repeat;">
	<nav style="margin-left: -9px; margin-right: -9px; margin-top: -8px; position: fixed; z-index: 1; top: 8px; width: 100%;">
	    <ul class="ls">
	        ...
	        <li class="ls"><a href="Dashboard.php" style="font-size: 17px!important;">Dashboard</a></li>
	        <li class="ls"><a href="profile.php" style="font-size: 17px!important;">Profile</a></li>
	        <li class="ls"><a href="Tagboard.php?val=Tags" style="font-size: 17px!important;">Tags</a></li>
	    </ul>
